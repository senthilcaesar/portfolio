        ...
        <Layout className='pt-16'>
          <ul className='grid grid-cols-3 gap-4 lg:gap-6 md:grid-cols-2 sm:grid-cols-1 sm:gap-y-8'>
            ...
            <FeaturedArticle
              ...
              summary='Data Discovery, Data Cleaning, Data Structuring, Data Validation, Data visualization'
              time='5 min read'
              link='https://woolly-revolve-fec.notion.site/Exploratory-Data-Analysis-25bbdfa1611d80faa160cfd9bdfae8e9?source=copy_link'
            />
            <FeaturedArticle
              img={anscombe}
